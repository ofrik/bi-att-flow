...
def get_word2vec(args, word_counter):
    glove_path = os.path.join(args.glove_dir, "F:\\Thesis_Code\\question_answering\\bi-att-flow-dev\\data\\glove\\glove.{}.{}d.txt".format(args.glove_corpus, args.glove_vec_size))
